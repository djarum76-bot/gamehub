...
class Pipe extends SpriteComponent with HasGameRef<FlappyBirdGame>{
  ...
  Future<void> onLoad()async{
    final pipe = await Flame.images.load(FlappyImages.pipe);
    final pipeRotated = await Flame.images.load(FlappyImages.pipeRotated);
    ...
    switch(pipePosition) {
      ...
      case PipePosition.bottom:
        position.y = gameRef.size.y - size.y - FlappyConfiguration.groundHeight;
        sprite = Sprite(pipe);
        break;
    }
